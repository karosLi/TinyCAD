...
// TinyCADMainFrm.cpp : CTinyCADMainFrame 类的实现
//
...
IMPLEMENT_DYNAMIC(CTinyCADMainFrame, CMDIFrameWndEx)

BEGIN_MESSAGE_MAP(CTinyCADMainFrame, CMDIFrameWndEx)
	ON_WM_CREATE()
	// 全局帮助命令
	...
	ON_COMMAND(ID_WINDOW_MANAGER, &CTinyCADMainFrame::OnWindowManager)
	ON_COMMAND_RANGE(ID_VIEW_APPLOOK_WIN_2000, ID_VIEW_APPLOOK_OFF_2007_AQUA, &CTinyCADMainFrame::OnApplicationLook)
	ON_UPDATE_COMMAND_UI_RANGE(ID_VIEW_APPLOOK_WIN_2000, ID_VIEW_APPLOOK_OFF_2007_AQUA, &CTinyCADMainFrame::OnUpdateApplicationLook)
END_MESSAGE_MAP()

// CTinyCADMainFrame 构造/析构

CTinyCADMainFrame::CTinyCADMainFrame()
{
	// TODO: 在此添加成员初始化代码
...
BOOL CTinyCADMainFrame::PreCreateWindow(CREATESTRUCT& cs)
{
...
BOOL CTinyCADMainFrame::CreateDockingWindows()
{
	BOOL bNameValid;
...
void CTinyCADMainFrame::SetDockingWindowIcons(BOOL bHiColorIcons)
{
...
// CTinyCADMainFrame 诊断

#ifdef _DEBUG
void CTinyCADMainFrame::AssertValid() const
{
	CMDIFrameWndEx::AssertValid();
}

void CTinyCADMainFrame::Dump(CDumpContext& dc) const
{
...
// CTinyCADMainFrame 消息处理程序

void CTinyCADMainFrame::OnWindowManager()
{
	ShowWindowsDialog();
}

void CTinyCADMainFrame::OnApplicationLook(UINT id)
{
	CWaitCursor wait;
...
void CTinyCADMainFrame::OnUpdateApplicationLook(CCmdUI* pCmdUI)
{
